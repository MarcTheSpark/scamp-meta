...
All code that is included in the core SCAMP libraries of pymusicxml, expenvelope, clockblocks, scamp, and scamp_extensions 
must be thoroughly reviewed and edited by a human being before being committed. Such code generally goes through many 
rounds of revision and redirection: we have found that AI coding tools can be very valuable, but the quality of the 
codebase inevitably reflects the quality of human effort and attention paid.
